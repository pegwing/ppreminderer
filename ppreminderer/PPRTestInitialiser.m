...
- (void) loadSchedule
{
    ...
    [self.clientActionScheduler scheduleEventsForClient:self.client4];
    [self.clientActionScheduler scheduleEventsForClient:self.client5];
    [self.clientActionScheduler scheduleEventsForClient:self.client6];
    [self.clientActionScheduler scheduleEventsForClient:self.client7];
    [self.clientActionScheduler scheduleEventsForClient:self.client8];
